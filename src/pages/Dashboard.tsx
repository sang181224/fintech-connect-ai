...
const contractorStats = [
  ...
  {
    label: "Milestone chờ nghiệm thu",
    value: "4",
    change: "Cần xử lý",
    icon: Hourglass,
...
const contractorActions = [
  {
    title: "3 milestone chờ bạn duyệt",
    desc: "Dự án UI/UX, Backend API, Branding",
    icon: FileCheck,
    type: "warning" as const,
  },
  {
    title: "Nạp thêm ₫15M vào escrow",
    desc: "Hợp đồng #1092 sắp thiếu quỹ",
    icon: Wallet,
    type: "error" as const,
  },
  {
    title: "1 tranh chấp cần phản hồi",
    desc: "Hợp đồng #1088 — Freelancer khiếu nại",
    icon: AlertCircle,
    type: "error" as const,
  },
];
...
const freelancerActions = [
  {
    title: "2 milestone cần gửi nghiệm thu",
    desc: "UI/UX App (MS#4), Backend API (MS#2)",
    icon: Send,
    type: "warning" as const,
  },
  {
    title: "1 milestone bị yêu cầu chỉnh sửa",
    desc: "Nội dung SEO – MS#5 cần bổ sung",
    icon: Edit3,
    type: "error" as const,
  },
  {
    title: "₫22M vừa được giải ngân",
    desc: "Hợp đồng #1089 – Milestone #3",
    icon: BadgeCheck,
...
const timelineEvents = [
  {
    id: 1,
    text: "Trần Minh gửi nghiệm thu MS#3 — UI/UX App",
    time: "10 phút trước",
    icon: Send,
    color: "text-primary",
  },
  {
    id: 2,
    text: "Bạn chấp nhận MS#2 — Backend API",
    time: "2 giờ trước",
    icon: CheckCircle2,
    color: "text-accent",
  },
  {
    id: 3,
    text: "Giải ngân ₫25M cho Lê Hoàng",
    time: "2 giờ trước",
  ...
  {
    id: 4,
    text: "Hợp đồng #1092 được tạo mới",
    time: "Hôm qua",
    icon: FileCheck,
    color: "text-primary",
  },
  {
    id: 5,
    text: "Nguyễn Lan gửi lại MS#5 sau chỉnh sửa",
    time: "Hôm qua",
    icon: Edit3,
    color: "text-destructive",
  },
...
const Dashboard = () => {
  ...
  const contracts =
    role === "contractor" ? contractorContracts : freelancerContracts;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Xin chào,{" "}
            <span className="font-medium text-foreground">Nguyễn Tuấn</span>
          </p>
        </div>
                      ...
                      <TableBody>
                        {contracts.map((c) => (
                          <TableRow
                            ...
                            onClick={() =>
                              navigate(`/dashboard/contracts/${c.code}`)
                            }
                          >
                            ...
                            <TableCell>
                              <Badge
                                variant={
                                  statusConfig[c.status]?.variant || "outline"
                                }
                              >
